...
function scrollAbr() {
  ...
  function r(e, t) {
    const n = Object.prototype.toString.call(e),
      ...
      r = "function" == typeof t;
    return o || console.error("Countable: Not a valid target"), r || console.error("Countable: Not a valid callback function"), o && r
  }

  function c(e, t) {
    let r = "" + ("value" in e ? e.value : e.textContent);
    (t = t || {}).stripTags && (r = r.replace(/<\/?[a-z][^>]*>/gi, "")), t.ignore && n.call(t.ignore, function(e) {
      r = r.replace(e, "")
    });
    const c = r.trim();
    return {
  ...
  const a = {
    on: function(e, o, a) {
      if (r(e, o)) return void 0 === e.length && (e = [e]), n.call(e, function(e) {
        const n = function() {
          o.call(e, c(e, a))
        };
        t.push({
          element: e,
          handler: n
        }), n(), e.addEventListener("input", n)
      }), this
    },
    off: function(e) {
      if (r(e, function() {})) return void 0 === e.length && (e = [e]), t.filter(function(t) {
    ...
    count: function(e, t, o) {
      if (r(e, t)) return void 0 === e.length && (e = [e]), n.call(e, function(e) {
        t.call(e, c(e, o))
      }), this
    },
    enabled: function(e) {
      return void 0 === e.length && (e = [e]), t.filter(function(t) {
        return -1 !== e.indexOf(t.element)
      }).length === e.length
    }
  };
